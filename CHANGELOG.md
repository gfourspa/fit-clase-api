...
## [0.1.14] - 2026-08-30[cgm]

### fixed
- shutdown graceful unico y prevenir acumulacion de listeners finish

## [0.1.13] - 2026-08-29[cgm]

### fixed
- serializar logs a JSON y evitar leak de listeners finish

## [0.1.12] - 2026-08-29[cgm]

### fixed
- migracion idempotente con enums en postgres

## [0.1.11] - 2026-08-29[cgm]

### fixed
- estructura de build para migraciones en Render

## [0.1.10] - 2026-08-29[cgm]

### fixed
- ejecutar migraciones en contenedor y corregir warning de ruta

## [0.1.9] - 2026-08-29

### feature
- flujo de aceptacion de invitaciones con validacion publica

## [0.1.8] - 2026-08-16

### Fixed
- Add a sanitized response DTO for users and map controller output:

Misc:
Improved token extraction and error handling in the helper script.

## [0.1.7] - 2026-08-14

### Fixed
- change relation gym user fk to set null

## [0.1.6] - 2026-08-13

### Changed
- change flow to aunthenticaded and fix segurity issues
